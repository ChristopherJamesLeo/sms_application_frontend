...
import AddCourseLevel,{EditCourseLevel} from '../models/SettingModels/CourseLevel';
...
export default function CourseLevel({title}){
    ...
    const onChange = async (checked, idx) => {
        ...
        try {
            const response = await api.put(`/courselevels/status/${idx}`, values, {
        ...
        <div className="table-container">
            ...
            <div className="my-4 ">
                <div className=' mb-3 flex gap-x-2'>
                    <AddCourseLevel fetchData = {fetchingData} />
                </div>
