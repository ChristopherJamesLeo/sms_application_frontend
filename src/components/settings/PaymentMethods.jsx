...
import AddPaymentMethod,{EditPaymentMethod} from '../models/SettingModels/PaymentMethod';
...
export default function PaymentMethods({title}){
    ...
    const onChange = async (checked, idx) => {
        ...
        try {
            const response = await api.put(`/paymentmethods/status/${idx}`, values, {
        ...
        <div className="table-container">
            ...
            <div className="my-4 ">
                <div className=' mb-3 flex gap-x-2'>
                    <AddPaymentMethod fetchData = {fetchingData} />
                </div>
