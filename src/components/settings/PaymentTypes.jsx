...
import AddPaymentType,{EditPaymentType} from '../models/SettingModels/PaymentType';

export default function PaymentTypes({title}){
    ...
    const onChange = async (checked, idx) => {
        ...
        try {
            const response = await api.put(`/paymenttypes/status/${idx}`, values, {
        ...
        <div className="table-container">
            ...
            <div className="my-4 ">
                <div className=' mb-3 flex gap-x-2'>
                    <AddPaymentType fetchData = {fetchingData} />
                </div>
