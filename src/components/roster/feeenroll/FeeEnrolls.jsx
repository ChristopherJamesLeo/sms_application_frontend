...
import AddEnroll,{EditEnroll} from "../enroll/AddEnroll";
import UserSearch from "../../inputs/UserSearch";
import FeeEnrollExport from '../../export/FeeEnrollExport';


export default function FeeEnrolls({title}){
    ...
    const fetchingData = async () => {
        try {
            ...
            const response = await api.get('/enroll/fees', {
